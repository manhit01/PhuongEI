(function () {
    ...
    $(".side").click(function () {
      $(".top,.bottom,.back,.front,.left").css("display", "none");
      $("body").css("background-image", "url(h7.jpg)");
      $("#card").addClass("active");
    });
    
    $(".img-wrap").click(function () {
      $(".top,.bottom,.back,.front,.left").css("display", "");
      $("body").css("background-image", "url(h8.jpg)");
